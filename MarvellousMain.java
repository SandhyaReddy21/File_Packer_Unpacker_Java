...
class MarvellousLogin extends Template implements ActionListener, Runnable
{
	...
	public MarvellousLogin()
	{
		...
		TopLabel.setText("Sansid Packer Unpacker : Login");
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		if(ae.getSource()==SUBMIT)
		{
			if(Validate(value1,value2) == false)
			{
				text1.setText("");
				text2.setText("");
				JOptionPane.showMessageDialog(this, "Short username","Sansid Packer Unpacker", JOptionPane.ERROR_MESSAGE);
			}
			if (value1.equals("SansidAdmin") &&value2.equals("SansidAdmin"))
			{
				NextPage page = new NextPage(value1);
				this.setVisible(true);
				page.pack();
				page.setVisible(true);
				page.setSize(2500, 2500);
			}
			else
			{
				attemp--;
				if(attemp == 0)
				{
					JOptionPane.showMessageDialog(this,"Number of attempts finished","SansidPackerUnpacker",JOptionPane.ERROR_MESSAGE);
					this.dispose();
					System.exit(0);
				}
